(function() {
    ...
    function initHeader() {
        ...
        largeHeader.style.height = height/1.175+'px';
        ...
        for(i in points) {
            var c = new Circle(points[i], 0.75+Math.random()*2, 'rgba(255,255,255,0.3)');
            points[i].circle = c;
        }
    }
